 ...
 *
 * На узких экранах шапка ниже — `h-16`, 64px, — и форма считается скрытой
 * на 8px раньше, чем уходит под шапку на самом деле. Оставлено сознательно:
 * наблюдение идёт за всей формой, и эти 8px ни на что не влияют.
 */
