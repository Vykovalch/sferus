...
export async function HeroSection() {
  ...
  return (
    ...
    // под текст.
    <section className="relative pt-16 md:pt-32 pb-[16%] overflow-hidden bg-hero-bg">
      {/* Декоративная иллюстрация: девяти- и пятиэтажки, деревья, облака,
          солнце и полоса тротуара по низу. Вектор, нарисован под этот сайт;
