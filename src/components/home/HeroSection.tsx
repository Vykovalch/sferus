...
export async function HeroSection() {
  ...
  return (
    ...
    // `pb-[14%]` — не декоративное число: у холста 1440×372 линия крыш дальнего
    // ряда проходит на 201px от низа, это 14% ширины. Такой отступ снизу держит
    // подпись над крышами на любой ширине, а сам рисунок продолжает уходить
    // под текст.
    <section className="relative pt-16 md:pt-32 pb-[14%] overflow-hidden bg-hero-bg">
      {/* Декоративная иллюстрация: девяти- и пятиэтажки, деревья, облака
          и солнце. Вектор, нарисован под этот сайт; в цветах палитры — холодные
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-x-0 bottom-0 aspect-[1440/372] bg-bottom bg-no-repeat bg-[length:100%_auto]"
