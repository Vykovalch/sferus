...
export async function HeroSection() {
  ...
  return (
    ...
    // `pb-[16%]` — не декоративное число: у холста 1440×398 линия крыш дальнего
    // ряда проходит на 227px от низа, это 16% ширины. Такой отступ снизу держит
    // подпись над крышами на любой ширине, а сам рисунок продолжает уходить
    // под текст.
    //
    ...
    <section className="relative pt-12 pb-[16%] overflow-hidden bg-hero-bg">
