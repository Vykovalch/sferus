...
export async function HeroSection() {
  ...
  return (
    ...
    // `pb-[18%]` — не декоративное число: у холста 1440×460 линия крыш дальнего
    // ряда проходит на 241px от низа, это 17% ширины. Такой отступ снизу держит
    // подпись над крышами на любой ширине, а сам рисунок продолжает уходить
    // под текст.
    <section className="relative pt-16 md:pt-32 pb-[18%] overflow-hidden bg-hero-bg">
