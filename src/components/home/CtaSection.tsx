 ...
 *
 * **Белый текст на оранжевой карточке нормы контраста не набирает** — 2.1:1
 * в светлом углу и 2.9:1 в тёмном при норме 4.5:1. Разработчик предлагал
 * тёмный текст (5.8:1 … 8.3:1) и показал вид рядом с образцом; владелец
 ...
 *
 * На серо-синей карточке белый в порядке: 4.2:1 в светлом углу — заголовок там
