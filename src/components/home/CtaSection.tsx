    ...
    <section className="py-20 bg-muted">
      <PageContainer>
        <div className="grid md:grid-cols-2 gap-6">
          {/* Для клиентов */}
          <div className="p-12 rounded-3xl bg-white border-2 border-primary relative overflow-hidden group">
            <div className="absolute top-8 right-8 xl:top-8 xl:right-8 opacity-5 text-primary group-hover:scale-125 transition-transform duration-500 hidden sm:block md:hidden xl:block">
            ...
            <div className="relative z-10">
              ...
              <Link
                href="/services"
                className="inline-block border-2 border-primary text-primary px-8 py-4 rounded-full font-semibold hover:bg-brand-fill hover:border-brand-fill hover:text-brand-fill-foreground transition-all active:scale-95"
              >
