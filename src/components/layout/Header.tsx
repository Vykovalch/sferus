        ...
        <div className="flex h-16 lg:h-[72px] items-center">
          <div className="flex w-full items-center justify-between gap-4 md:gap-8">
            ...
            {/* Правая часть сгруппирована по типу (решения владельца,
                ...
                Шаги внутри правой части: 16px между её частями, 8px внутри
                личного блока (решение владельца, 2026-09-23). Было 12 и 4:
                при наведении подсветки иконок 40px почти соприкасались.
                Ниже 1024px черты нет — границу между поиском и личным блоком
                держит только этот отступ, поэтому разница в шагах обязательна. */}
