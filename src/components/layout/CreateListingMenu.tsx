 ...
 * свёрнутый в лупу поиск не теряется — он в одно нажатие и в шторке получает
 * больше места, чем имел бы в тесной шапке. А кнопка в бургере пропадает
 * для всех, кто меню не открывает. Порог вернули: **элемент уходит из шапки,
 * когда перестаёт помещаться, а не по рангу**; ранг решает только очерёдность
 * при нехватке места. На 768px кнопка помещается с запасом ~254px.
 *
