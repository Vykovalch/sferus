      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex items-center justify-between pt-0.5">
          <div className="flex items-center space-x-2">
            <Checkbox id="remember" name="remember" className="cursor-pointer border-input data-[state=checked]:bg-brand data-[state=checked]:text-brand-foreground" />
            <Label htmlFor="remember" className="text-sm font-normal text-muted-foreground cursor-pointer select-none">
              Запомнить меня
            </Label>
          </div>
          <Link href="/forgot-password" className="text-sm text-brand hover:underline font-medium cursor-pointer">
            Забыли пароль?
          </Link>
        </div>
