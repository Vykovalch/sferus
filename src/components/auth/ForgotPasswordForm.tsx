...
export function ForgotPasswordForm() {
  ...
  if (submitted) {
    return (
      <div className="w-full text-center bg-card text-foreground animate-in fade-in duration-300 px-6 pb-10 md:pt-10 md:px-8 md:pb-8 md:rounded-2xl md:border md:border-border">
