  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          ...
          <div className="w-full lg:w-80 lg:flex-shrink-0 lg:sticky lg:top-6 order-1 lg:order-2">
            <div className="bg-card border border-border rounded-xl p-5">
              ...
              {contactButton(
                "hidden lg:flex w-full h-10 rounded-full bg-brand hover:bg-brand/90 text-brand-foreground shadow cursor-pointer font-medium transition-colors",
              )}
            </div>
          </div>
        </div>
      ...
      <div className="lg:hidden fixed inset-x-0 bottom-0 z-40 bg-card border-t border-border px-4 py-3">
        {contactButton(
          "w-full h-10 rounded-full bg-brand hover:bg-brand/90 text-brand-foreground shadow cursor-pointer font-medium transition-colors",
        )}
      </div>
    </div>
  );
